...
const About = () => {
  return (
    <div className='w-full px-8'>
      <div className='w-full max-w-6xl md:py-0 py-8 h-auto md:h-[10rem] rounded-2xl mx-auto bg-[#19191b] px-4 sm:px-6 md:px-10 flex flex-col md:flex-row items-center justify-center'>
