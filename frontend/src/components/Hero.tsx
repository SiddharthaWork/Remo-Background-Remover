...
const Hero = () => {
    return (
        <div className="relative h-fit md:mb-28 w-full bg-white text-black dark:bg-black dark:text-white lg:py-0 py-8 transition-colors">
            ...
            <div className='flex flex-col lg:flex-row w-full max-w-6xl p-4 sm:p-6 xl:px-0 lg:py-8 mx-auto gap-6 sm:gap-8 lg:gap-10 min-h-[60vh] h-auto justify-center items-center'>
                ...
                <div className='absolute -top-8 left-11 md:-top-8 md:left-60 lg:-top-10 lg:left-0'>
                    ...
                    <p className='text-neutral-500 dark:text-neutral-300 text-sm sm:text-lg md:text-xl font-semibold'>
                    ...
                    <div className='mt-3 sm:mt-4 flex flex-row gap-4 sm:gap-6 items-center sm:items-center justify-center lg:justify-start'>
                        ...
                        <p className='text-black dark:text-white text-base sm:text-lg md:text-sm xl:text-base lg:min-w-[5rem] '>Try it for <br /><span className='font-bold text-xl lg:text-2xl text-[#61db3f]'>Free</span></p>
                    </div>
                </div>
                <div className='bg-white dark:bg-neutral-900 w-full lg:w-2/3 h-48 sm:h-64 md:h-80 lg:h-full max-h-[16rem] sm:max-h-[20rem] md:max-h-[24rem] rounded-2xl overflow-hidden mt-6 lg:mt-0'>
