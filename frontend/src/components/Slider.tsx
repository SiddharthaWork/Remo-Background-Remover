...
const Slider = () => {
  ...
  return (
    <div className="w-full px-2 sm:px-4 md:px-0 bg-white text-black dark:bg-black dark:text-white transition-colors">
      ...
      {/* Image */}
      <div className='w-full max-w-2xl md:max-w-6xl rounded-xl mx-auto mt-8 sm:mt-10 relative overflow-hidden aspect-[16/9] bg-neutral-200 dark:bg-neutral-900'>
        ...
        <input type="range" value={slider} onChange={handlerSlider} min={0} max={101}
          className='absolute w-11/12 sm:w-full left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 slider bg-black dark:bg-white outline-none' />
      </div>
